...
namespace RockyProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //get handlers 
        // All methods inside page is handler
            ...
            if (ModelState.IsValid)
            {
                ...
                {       // if result successfull
                    ...
                    else
                    {
                        if (!User.IsInRole(WC.AdminRole))
                        {
                            //TempData[WC.Success] = user.UserName + "has been registered";
        ...
        private IdentityUser ApplcationUser()
        {
            try
            {
